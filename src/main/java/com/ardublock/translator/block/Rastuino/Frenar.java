...
public class Frenar extends TranslatorBlock
{
        
        public Frenar(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
        {
