/******************************************************************************
  ...
  Block: Rastuino_Invertir
  Rastuino API: Invertir
...
public class Invertir extends TranslatorBlock
{
        public Invertir(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
        {
